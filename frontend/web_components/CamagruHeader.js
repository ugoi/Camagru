...
template.innerHTML = `    
    <link rel="stylesheet" href="/web_components/header.css" />
    <header class="header">
      <nav class="nav">
        <ul class="nav-list">
          <li>
          ...
          <li>
            <a href="/feed" class="nav-link" title="Feed">
              <svg style="width: 20px; height: 20px;" viewBox="0 0 576 512">
          ...
          <li>
            <a href="/webcam" class="nav-link" title="Create">
        ...
        <div class="auth-buttons">
          <button id="login-btn" onclick="window.location.href='/login'" class="auth-btn">
            Login
          </button>
          <button id="logout-btn" onclick="this.getRootNode().host.handleLogout()" class="auth-btn">
            Logout
          </button>
        </div>
      </nav>
